...
/**
 * @brief Load sensor configuration from menuconfig
 * 
 * Loads all sensor-related parameters from the ESP-IDF configuration system
 * and populates the sensor configuration structure. This function reads the
 * CONFIG_* macros generated by the menuconfig system from Kconfig.projbuild.
 * 
 * @param sensor_config Pointer to sensor configuration structure to populate
 */
static void load_sensor_config(system_sensor_config_t *sensor_config) {
    // MPU6050 I2C address configuration from menuconfig
#ifdef CONFIG_MPU6050_I2C_ADDR_DEFAULT
    sensor_config->mpu6050_i2c_address = 0x68;
#elif defined(CONFIG_MPU6050_I2C_ADDR_ALT)
    sensor_config->mpu6050_i2c_address = 0x69;
#else
    sensor_config->mpu6050_i2c_address = 0x68;  // Default fallback
#endif
    
    // MPU6050 I2C frequency from menuconfig
#ifdef CONFIG_MPU6050_I2C_FREQUENCY
    sensor_config->mpu6050_i2c_frequency = CONFIG_MPU6050_I2C_FREQUENCY;
#else
    sensor_config->mpu6050_i2c_frequency = 400000;  // Default 400kHz
#endif
    
    // MPU6050 accelerometer range configuration from menuconfig
#ifdef CONFIG_MPU6050_ACCEL_2G
    sensor_config->mpu6050_accel_range = 0;  // ±2g
#elif defined(CONFIG_MPU6050_ACCEL_4G)
    sensor_config->mpu6050_accel_range = 1;  // ±4g
#elif defined(CONFIG_MPU6050_ACCEL_8G)
    sensor_config->mpu6050_accel_range = 2;  // ±8g
#elif defined(CONFIG_MPU6050_ACCEL_16G)
    sensor_config->mpu6050_accel_range = 3;  // ±16g
#else
    sensor_config->mpu6050_accel_range = 0;  // Default ±2g
#endif
    
    // MPU6050 gyroscope range configuration from menuconfig
#ifdef CONFIG_MPU6050_GYRO_250DPS
    sensor_config->mpu6050_gyro_range = 0;   // ±250°/s
#elif defined(CONFIG_MPU6050_GYRO_500DPS)
    sensor_config->mpu6050_gyro_range = 1;   // ±500°/s
#elif defined(CONFIG_MPU6050_GYRO_1000DPS)
    sensor_config->mpu6050_gyro_range = 2;   // ±1000°/s
#elif defined(CONFIG_MPU6050_GYRO_2000DPS)
    sensor_config->mpu6050_gyro_range = 3;   // ±2000°/s
#else
    sensor_config->mpu6050_gyro_range = 0;   // Default ±250°/s
#endif
    
    // MPU6050 digital low pass filter configuration from menuconfig
#ifdef CONFIG_MPU6050_DLPF_260HZ
    sensor_config->mpu6050_dlpf_mode = 0;
#elif defined(CONFIG_MPU6050_DLPF_184HZ)
    sensor_config->mpu6050_dlpf_mode = 1;
#elif defined(CONFIG_MPU6050_DLPF_94HZ)
    sensor_config->mpu6050_dlpf_mode = 2;
#elif defined(CONFIG_MPU6050_DLPF_44HZ)
    sensor_config->mpu6050_dlpf_mode = 3;
#elif defined(CONFIG_MPU6050_DLPF_21HZ)
    sensor_config->mpu6050_dlpf_mode = 4;
#elif defined(CONFIG_MPU6050_DLPF_10HZ)
    sensor_config->mpu6050_dlpf_mode = 5;
#elif defined(CONFIG_MPU6050_DLPF_5HZ)
    sensor_config->mpu6050_dlpf_mode = 6;
#else
    sensor_config->mpu6050_dlpf_mode = 3;    // Default 44Hz
#endif
    
    // MPU6050 feature flags from menuconfig
#ifdef CONFIG_MPU6050_ENABLE_CALIBRATION
    sensor_config->mpu6050_enable_calibration = CONFIG_MPU6050_ENABLE_CALIBRATION;
#else
    sensor_config->mpu6050_enable_calibration = true;  // Default enabled
#endif
    
#ifdef CONFIG_MPU6050_CALIBRATION_SAMPLES
    sensor_config->mpu6050_calibration_samples = CONFIG_MPU6050_CALIBRATION_SAMPLES;
#else
    sensor_config->mpu6050_calibration_samples = 1000;  // Default 1000 samples
#endif
    
#ifdef CONFIG_MPU6050_ENABLE_STATISTICS
    sensor_config->mpu6050_enable_statistics = CONFIG_MPU6050_ENABLE_STATISTICS;
#else
    sensor_config->mpu6050_enable_statistics = true;   // Default enabled
#endif
    
#ifdef CONFIG_MPU6050_ENABLE_DEBUG_LOGGING
    sensor_config->mpu6050_enable_debug = CONFIG_MPU6050_ENABLE_DEBUG_LOGGING;
#else
    sensor_config->mpu6050_enable_debug = false;      // Default disabled
#endif
    
    ESP_LOGD(TAG, "Sensor configuration loaded from menuconfig");
    ESP_LOGD(TAG, "MPU6050: addr=0x%02X, freq=%luHz, accel_range=%d, gyro_range=%d", 
             sensor_config->mpu6050_i2c_address, sensor_config->mpu6050_i2c_frequency,
             sensor_config->mpu6050_accel_range, sensor_config->mpu6050_gyro_range);
    ESP_LOGD(TAG, "MPU6050: dlpf=%d, cal=%s, stats=%s, debug=%s", 
             sensor_config->mpu6050_dlpf_mode,
             sensor_config->mpu6050_enable_calibration ? "on" : "off",
             sensor_config->mpu6050_enable_statistics ? "on" : "off",
             sensor_config->mpu6050_enable_debug ? "on" : "off");
}
...
esp_err_t system_config_init(void) {
    ...
    load_sensor_config(&g_system_config.sensors);
...
const system_sensor_config_t* system_config_get_sensors(void) {
    const system_config_t *config = system_config_get();
    return config ? &config->sensors : NULL;
}
